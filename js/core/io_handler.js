...
export function updateHtmlEvent(event) {
    ...
    switch (event["character"]) {
        case "Marechal Silva":
            document.getElementById("imagem2").src = "JoguinDeMesa/img/personagens/marechal.png";
            break;
        case "Tenente Taísa Torres":
            document.getElementById("imagem2").src = "JoguinDeMesa/img/personagens/tenente.png";
            break;
        case "Sargento Márcio":
            document.getElementById("imagem2").src = "JoguinDeMesa/img/personagens/sargento.png";
            break;
        case "Economista Síntia":
            document.getElementById("imagem2").src = "JoguinDeMesa/img/personagens/economista.png";
            break;
        case "Banqueiro Bruno Barros":
            document.getElementById("imagem2").src = "JoguinDeMesa/img/personagens/banqueiro.png";
            break;
        case "Contador Roberto":
            document.getElementById("imagem2").src = "JoguinDeMesa/img/personagens/contador.png";
            break;
        case "Recenseadora do IBGE Maria":
            document.getElementById("imagem2").src = "JoguinDeMesa/img/personagens/recenseadora.png";
            break;
        case "Jornalista Jaime Jason":
            document.getElementById("imagem2").src = "JoguinDeMesa/img/personagens/jornalista.png";
            break;
        case "Guarda Glória Góis":
            document.getElementById("imagem2").src = "JoguinDeMesa/img/personagens/guarda.png";
            break;
        case "Karateca Kátia Kane":
            document.getElementById("imagem2").src = "JoguinDeMesa/img/personagens/karateca.png";
            break;
    }
}