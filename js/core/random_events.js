const event_random = [
    ...
    },
    {
        ...
        "choices": [
                        {
                "text": "Ignorem. Devem ser apenas pescadores",
                "effects": {
                    "military": -5,
                    "finance": +0,
                    "population": +0,
    ...
    },
    {
        ...
        "choices": [
            ...
            {
                "text": "Criar programas de auxílio às mulheres",
                "effects": {
                    "military": +0,
                    "finance": -10,
                    "population": +10,
            ...
            {
                "text": "Não faremos nada à respeito",
                "effects": {
                    "military": +0,
                    "finance": +0,
                    "population": -10,
    ...
    },
    {
        ...
        "choices": [
            ...
            {
                "text": "Problema delas, não do país",
                "effects": {
                    "military": +0,
                    "finance": +0,
                    "population": -10,
    ...
    },
    {
        ...
        "choices": [
            ...
            {
                "text": "Criar programas para aumentar ainda mais a natalidade",
                "effects": {
                    "military": +0,
                    "finance": -15,
                    "population": +50,
    ...
    },
    {
        ...
        "choices": [
            ...
            {
                "text": "Reduzir o custo de casas no interior",
                "effects": {
                    "military": +0,
                    "finance": -10,
                    "population": +15,
    ...
    },
    {
        ...
        "choices": [
            ...
            {
                "text": "Isso não é minha responsabilidade",
                "effects": {
                    "military": +0,
                    "finance": -5,
                    "population": -10,
            ...
            {
                "text": "Não deixe as pessoas saberem dessa taxa",
                "effects": {
                    "military": +0,
                    "finance": +0,
                    "population": -15,
    ...
    },
    {
        ...
        "choices": [
            ...
            {
                "text": "Forçar os indígenas a trabalhar",
                "effects": {
                    "military": +0,
                    "finance": +5,
                    "population": +10,
    ...
    },
    {
        ...
        "choices": [
            ...
            {
                "text": "Criar programa de auxílio para mendigos",
                "effects": {
                    "military": +0,
                    "finance": -20,
                    "population": +10,
            ...
            {
                "text": "Isolar os moradores de ruas em favelas",
                "effects": {
                    "military": +0,
                    "finance": -10,
                    "population": -5,
    ...
    },
    {
        ...
        "choices": [
            ...
            {
                "text": "Criar políticas públicas para incluir os jovens",
                "effects": {
                    "military": +0,
                    "finance": -10,
                    "population": +10,
    ...
    },
    {
        ...
        "choices": [
            ...
            {
                "text": "O índice não está tão alto",
                "effects": {
                    "military": +5,
                    "finance": +5,
                    "population": -5,
    ...
    },
    {
        ...
        "choices": [
            ...
            {
                "text": "Não há necessidade de fazer algo",
                "effects": {
                    "military": +0,
                    "finance": +5,
                    "population": -10,
            ...
            {
                "text": "Mande prender quem reclamar",
                "effects": {
                    "military": +10,
                    "finance": -10,
                    "population": -10,
    ...
    },
    {
        ...
        "choices": [
                        {
                "text": "Prendam-os e avisem ao marechal",
                "effects": {
                    "military": -10,
                    "finance": -10,
                    "population": +0,
            ...
            {
                "text": "Investiguem o grupo; se fizerem algo de errado, pode prender",
                "effects": {
                    "military": -5,
                    "finance": -15,
                    "population": +0,
    ...
    },
    {
        ...
        "choices": [
                        {
                "text": "Isso é ridículo, não irei permitir",
                "effects": {
                    "military": +15,
                    "finance": +0,
                    "population": -5,
            ...
            {
                "text": "Sim, deixe-os falar o que quiserem",
                "effects": {
                    "military": -10,
                    "finance": +0,
                    "population": +0,
    ...
    },
    {
        ...
        "choices": [
            ...
            {
                "text": "De quem vocês querem se defender?",
                "effects": {
                    "military": +5,
                    "finance": +5,
                    "population": -5,
